...
table_water.put_item(Item={'month-year': '03-2022', 'days': days})

days = []
for i in range(30):
	days.append(int(random.randint(100,325)))
table_water.put_item(Item={'month-year': '04-2022', 'days': days})

days = []
for i in range(31):
	days.append(int(random.randint(125,350)))
table_water.put_item(Item={'month-year': '05-2022', 'days': days})
	
table_water.put_item(Item={'month-year': '06-2022', 'days': []})
for i in range(int(datetime.datetime.now().strftime("%d")) - 1):
	element = table_water.get_item(Key={'month-year': '06-2022'})
	days = element['Item']['days']
	days.append(int(random.randint(150,375)))
	table_water.update_item(Key={'month-year': '06-2022'}, UpdateExpression="set days = :days", ExpressionAttributeValues={':days': days})
	
table_fields.put_item(Item={'id': '1', 'mq_available': '500', 'crop_type': 'corn', 'ph': '6'})
table_fields.put_item(Item={'id': '2', 'mq_available': '350', 'crop_type': 'soy', 'ph': '7'})
table_fields.put_item(Item={'id': '3', 'mq_available': '600', 'crop_type': 'chard', 'ph': '5'})
table_fields.put_item(Item={'id': '4', 'mq_available': '550', 'crop_type': 'rice', 'ph': '1'})

table_greenhouses.put_item(Item={'id': '1', 'mq_available': '100', 'crop_type': 'fruit', 'ph': '8'})
